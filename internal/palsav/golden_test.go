...
func TestDecodeGolden(t *testing.T) {
	save, err := ParseGVAS(goldenArchive())
	if err != nil {
...
// goldenHintedNesting reproduces the nesting that activates palworldTypeHints,
// where a MapProperty declares StructProperty keys whose real identity is only
// known from the property path.
